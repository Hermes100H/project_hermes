...
from utils.constants import CONST_g, TIME_ON_FAILURE
...
def compute_times_with_air_friction(boost_profile: List, circuit: Circuit):
    ...
    for i in range(dx_list.size):
        ...
        current_segment_time, initial_speed = solve_position_ode_with_air_friction(delta_x=dx, initial_speed=initial_speed, boost_force=boost_force, theta=theta)
